...
let transpoter = nodemailer.createTransport({
  ...
  auth:{
    ...
    pass:'xjsm lhxa cpeb hpqj', //password
  }
})
...
exports.sendmail  = async function ({to,subject,text,html}){
  ...
  let info = await transpoter.sendMail({
    from:`"Milurry " <sameerrajyt@gmail.com`,
    to,
    subject,
    text,
    html
...
exports.AccountCreatedTemplate = function(){
  return (`<!DOCTYPE html>
  <html>
  <head>
            ...
            <tr>
              <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td align="left" width="60%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>Total</strong></td>
                    <td align="left" width="20%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>$40</strong></td>
                    <td align="left" width="20%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>$500</strong></td>
                  </tr>
                </table>
              </td>
            </tr>
